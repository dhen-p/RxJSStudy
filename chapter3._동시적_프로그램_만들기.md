...
<iframe height='265' scrolling='no' src='//codepen.io/dhen-p/embed/xOaNaL/?height=265&theme-id=0&default-tab=result&embed-version=2' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'>See the Pen <a href='http://codepen.io/dhen-p/pen/xOaNaL/'>RxJS test</a> by Daehyun Park (<a href='http://codepen.io/dhen-p'>@dhen-p</a>) on <a href='http://codepen.io'>CodePen</a>.</iframe>### 효율적인 파이프라인JS에서 Array를 chaining operator를 사용해서 변형하게되면 비용이 많이든다. operator를 거칠때마다 새로운 Array를 리턴하기 때문이다. 하지만 Observable 파이프라인은 중간에 새로운 Observable을 만들지 않고, 모든 operator를 거친 Observable을 리턴한다. 이러한점에서 매우 효율적이라고 할수 있습니다.
...
<iframe height='265' scrolling='no' src='//codepen.io/dhen-p/embed/PzyoOw/?height=265&theme-id=0&default-tab=result&embed-version=2' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'>See the Pen <a href='http://codepen.io/dhen-p/pen/PzyoOw/'>RxJSSubject</a> by Daehyun Park (<a href='http://codepen.io/dhen-p'>@dhen-p</a>) on <a href='http://codepen.io'>CodePen</a>.
</iframe>
